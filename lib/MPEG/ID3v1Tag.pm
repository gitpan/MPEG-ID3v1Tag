...
The ID3v1Tag routines are useful for setting and reading ID3 MPEG Audio Tags.
Just create an MPEG::ID3v1Tag Object with the path to the file of interest,
...
if a particular MPEG file contains an ID3 Tag.
...
For more specific references to the MPEG Audio ID3 Tags visit 
http://www.id3.org/
